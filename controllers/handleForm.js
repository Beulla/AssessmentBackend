    ...
    try{
        ...
        if(!validatePhoneNumber(phoneNumber)){
            ...
            return res.status(400).json({
                ...
                info:"Phone number should be atleast 10 numbers"
            })
        }
        ...
        pool.query(sql1, (error, results, fields) => {
          ...
          const emailBody = `
              ...
              "purposeOfImportation":${purposeOfImportation},
            ...
            `;
          sendEmail('Request sent', 'Thank you for using our services, here is your sent data', {
            email,emailBody
          });
